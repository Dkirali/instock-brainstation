                            ...
                            <div className="warehouse__information-data">
                                <div className="warehouse__information-top">
                                    <div className="warehouse__information-location">
                                        ...
                                        <Link to={`warehouses/${warehouse.id}`} className="warehouse__location"><p className="warehouse__location-p">{warehouse.name}</p> <img className="warehouse__chevron" src={Chevron}alt="trashcan"/></Link>
                                    </div>
