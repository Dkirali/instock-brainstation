    ...
    return (
        <section className='inventory'>
            <div className='inventory__nav'>
                ...
                <form className='inventory__form'>
                    ...
                    <button className='inventory__button' type='submit'>
                        <h3 className='inventory__button-text'>
                            + Add New Item
                        </h3>{" "}
                    </button>
                </form>
            ...
            <ul className='inventory-topbar'>
                <li className='inventory-topbar__inventory'>
                    INVENTORY ITEM
                    <img
                        className='inventory-topbar__sort'
                        src={Sort}
                        alt='up arrow and down arrow'
                    />
                </li>
                <li className='inventory-topbar__category'>
                    CATEGORY{" "}
                    <img
                        className='inventory-topbar__sort'
                        src={Sort}
                ...
                <li className='inventory-topbar__status'>
                    STATUS{" "}
                    <img
                        className='inventory-topbar__sort'
                        src={Sort}
                ...
                <li className='inventory-topbar__qty'>
                    {" "}
                    QTY{" "}
                    <img
                        className=' inventory-topbar__sort'
                ...
                <li className='inventory-topbar__warehouse'>
                    WAREHOUSE{" "}
                    <img
                        className='inventory-topbar__sort'
                        src={Sort}
                ...
                <li className='inventory-topbar__actions'>
                    ACTIONS{" "}
                    <img
                        className='inventory-topbar__sort'
                        src={Sort}
                            ...
                            <div className='inventory__information-data'>
                                ...
                                <div className='inventory__information-bottom'>
                                    <div className='inventory__information-status'>
                                        ...
                                        <p className='inventory__warehouse-status'>
                                            {" "}
                                            {item.status}
                                        </p>
                                    </div>
                                    <div className='inventory__information-quantity-information'>
                                        ...
                                        <p className='inventory__warehouse-info'>
                                            {item.quantity}
                                        </p>
                                    </div>
